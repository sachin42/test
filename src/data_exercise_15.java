//15. Write a Java program to get the next floating-point adjacent in the direction of positive and negative
// infinity from a given float/double number.
public class data_exercise_15 {
